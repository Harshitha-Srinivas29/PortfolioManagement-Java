...
<body>
    <nav class="navbar navbar-dark bg-dark" style="margin-left: 20px;">
        <a class="navbar-brand" href="#">
          ...
          Portfolio Manager</a>
        <form action="/dailyAllSharePrice" method="GET"><button type="button float-left" class="btn btn-outline-light">Daily Share Price</button></form>
        <form action="/MutualFund" method="GET"><<button type="button float-left" class="btn btn-outline-light">Mutual Fund</button></form>
